class Cascade < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/cascade/arm64_sonoma/1.0.0.bottle.tar.gz"
      sha256 "b492546a3b8ec9eafdaa966de06ab0ef16fe138a294e65192cdaf761533b34b6"
    end
    on_intel do
